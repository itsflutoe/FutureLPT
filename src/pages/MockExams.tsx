...
const PRESETS = [
  ...
  { title: 'Full BEEd Simulation', desc: 'Mixed GenEd + ProfEd · 150 questions', category: 'MIXED', count: 150, mode: 'mock' },
  { title: 'Specialization Practice', desc: 'Elementary Education · 50 questions · Timed', category: 'SPECIALIZATION', count: 50, mode: 'mock' },
  { title: 'Specialization Mock', desc: 'Elementary Education · 100 questions · Full timer', category: 'SPECIALIZATION', count: 100, mode: 'mock' },
];
